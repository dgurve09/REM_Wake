...
All 13/14 in-run checks passed. Thresholds were selected on pooled out-of-fold predictions from the same 64 train participants. This result is developmental and is not independent confirmation.
