...
**Planned research window:** 2026-06-22 to 2026-12-20  
...
### Block 1: June 22 to July 5 - Project setup and data access
...
- Verify BOAS access, version, files, licenses, channels, labels, and metadata.
- Create the dataset manifest and initial weekly SR&ED records.

**Decision:** Is the expected paired dataset accessible and internally consistent?

### Block 2: July 6 to July 19 - Event inventory and feasibility gate
...
### Block 3: July 20 to August 2 - Minimal preprocessing and labels
...
### Block 4: August 3 to August 16 - Stage-first baseline
...
### Block 5: August 17 to August 30 - Direct transition baselines
...
### Block 6: August 31 to September 13 - Paired PSG-to-wearable transfer
...
### Block 7: September 14 to September 27 - Robustness and justified adaptation

- Test missing channels, signal degradation, and participant variability.
- Add one justified adaptation method only if required by Block 6 evidence.
- Perform modality ablations where data coverage permits.

**Deliverable:** Robustness and ablation report.

### Block 8: September 28 to October 11 - External PSG generalization
...
### Block 9: October 12 to October 25 - Temporal localization under uncertainty
...
### Block 10: October 26 to November 8 - Transition-derived measures
...
**Deliverable:** Technical measure definitions and reliability results.

### Block 11: November 9 to November 22 - Conditional streaming prototype

- Proceed only if offline performance supports meaningful demonstration.
- Build chronological windowed inference without future leakage.
- Benchmark latency and memory on documented hardware.

**Deliverable:** Command-line research prototype or documented no-go decision.

### Block 12: November 23 to December 6 - Reproducibility and independent QA
...
**Deliverable:** Reproducibility and QA report.

### Block 13: December 7 to December 20 - Final analysis and documentation
...
- **M0, July 19:** Feasibility decision completed.
- **M1, August 2:** Reproducible labels and preprocessing completed.
- **M2, August 30:** Stage-first and direct transition baselines compared.
- **M3, September 27:** PSG-to-wearable transfer and robustness assessed.
- **M4, November 22:** Temporal analysis completed and streaming decision made.
- **M5, December 20:** Final results, reproducibility package, and evidence index completed.
...
2. Esparza-Iaizzo M, Sierra-Torralba M, Klinzing JG, Minguez J, Montesano L, Lopez-Larraz E. Automatic sleep scoring for real-time monitoring and stimulation in individuals with and without sleep apnea. *bioRxiv*. 2024. https://doi.org/10.1101/2024.06.12.597764
